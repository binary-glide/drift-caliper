...
Satisfies ``drift_caliper.baseline.domain.fitted_control_limits.FittedControlLimits``
...
``drift_caliper.baseline.domain.ewma_fitting.fit_ewma`` (BIN-65) is the only place
...
class FittedEWMA(FittedArtefactBase):

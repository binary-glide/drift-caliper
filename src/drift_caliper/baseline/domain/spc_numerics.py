...
Hoisted out of ``drift_caliper.baseline.domain.ewma_fitting`` during BIN-94, per the
...
``drift_caliper.baseline.domain.ewma_fitting`` needs: a module whose only callers
